...
<body>
    <div class="navbar navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo site_url('');?>"><strong>PERWASLITEK - PDAM TIRTA PAKUAN KOTA BOGOR</strong></a>
        </div>
...
<div class="row">
    ...
    <div class="col-md-8 ">
        <h4 align="center">SISTEM INFORMASI MANAJEMEN PERWASLITEK</h4><hr class="line-title"> 
        <img src="<?php echo base_url(); ?>assets/img/banner/pdamtpkb2.png" alt="Belum Tersedia" class="img-responsive">
    </div>
</div>
</div>
